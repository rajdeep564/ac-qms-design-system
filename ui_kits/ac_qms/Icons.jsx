...
const Icon = ({ size = 16, stroke = 1.75, children, ...rest }) => (
  <svg
    className="icon"
...
Object.assign(window, {
  Icon,
  IconLayoutDashboard, IconFileText, IconPackage, IconAlertTriangle,
  IconCircleAlert, IconPenLine, IconCheck, IconX, IconSearch, IconFilter,
  IconUser, IconHistory, IconSettings, IconLock,
  IconChevronRight, IconChevronDown, IconPlus, IconArrowRight,
  IconDownload, IconBell,
});
